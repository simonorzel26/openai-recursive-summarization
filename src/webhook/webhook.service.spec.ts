...
//       textToSummarize: 'Sample text for summarization.',
//       summaryMaxTokenCount: 100,
//       summarizationPrompt: 'Please summarize the following text:',
//       summarizationRetrievalWebhooURL: 'http://localhost:3000/webhook',
//       batchId: 'batch123',
//       status: 'completed',
//     };
